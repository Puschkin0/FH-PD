...
import com.dit599.customPD.actors.buffs.Barkskin;
...
import com.dit599.customPD.actors.buffs.Charm;
import com.dit599.customPD.actors.buffs.Combo;
import com.dit599.customPD.actors.buffs.Cripple;
import com.dit599.customPD.actors.buffs.Fury;
import com.dit599.customPD.actors.buffs.GasesImmunity;
...
import com.dit599.customPD.items.keys.GoldenKey;
...
import com.dit599.customPD.levels.features.Sign;
		...
		if (wep != null) {
			...
			case BATTLEMAGE:
				if (wep instanceof Wand) {
					...
					if (Dungeon.qsRight == wand) {
						QuickSlot.refresh(true);
					}
					else if (Dungeon.qsLeft == wand) {
