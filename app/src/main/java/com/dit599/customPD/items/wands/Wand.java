...
import com.dit599.customPD.items.ItemStatusHandler;
import com.dit599.customPD.items.KindOfWeapon;
import com.dit599.customPD.items.bags.Bag;
import com.dit599.customPD.items.rings.RingOfPower.Power;
	...
	protected static CellSelector.Listener zapper = new  CellSelector.Listener() {
		...
		public void onSelect( Integer target ) {
			...
			if (target != null) {
				...
				if(curItem.equals(Dungeon.qsRight)){
					QuickSlot.target( curItem, Actor.findChar( cell ) );
				}
				else if (curItem.equals(Dungeon.qsLeft)){
					QuickSlot.target( curItem, Actor.findChar( cell ) );
				}
