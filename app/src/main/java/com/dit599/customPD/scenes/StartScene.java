...
import com.dit599.customPD.effects.BannerSprites.Type;
...
import com.dit599.customPD.windows.WndChallenges;
import com.dit599.customPD.windows.WndClass;
...
public class StartScene extends PixelScene {
	...
	private void updateClass( HeroClass cl ) {
		...
		if (cl != HeroClass.HUNTRESS || Dungeon.isTutorial || Dungeon.template != null || huntressUnlocked) {
	...
	private class ChallengeButton extends Button {
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				StartScene.this.add( new WndChallenges( CustomPD.challenges(), true ) {
